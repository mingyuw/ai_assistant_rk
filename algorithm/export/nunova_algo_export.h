...
//mix混合�?
extern void OffDebug();//关闭平台调试信息(打印，保存图片，保存数据文档)
extern void OnDebug();//打开平台调试打印信息(打印，保存图片，保存数据文档)
extern void SetLogLevel(int level);//设置调试信息的打印等�?-4�?：什么也不打印；1：err�?：warn�?：info�?：dbg
